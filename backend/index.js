...
app.get('/auth/google/callback',
  ...
  function(req, res) {
    ...
    {  
      res.redirect(p`http://localhost:3001/FirstVisit`);
    }
    else {
      res.redirect(`http://localhost:3001/Sucess`);
    }
  });
...
app.get('/auth/github/callback',
  ...
  function(req, res) {
    ...
    {  
      ...
      res.redirect(`http://localhost:3001/FirstVisit`);
    }
    else res.redirect(`http://localhost:3001/Sucess`);
  });
